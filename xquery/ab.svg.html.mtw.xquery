...
<html>
    <head>
        <title>Music of the Waters: Shanties per Country</title>
    </head>
    <body>
        <h1>Shanties by Nation in "The Music of the Waters" (1888)</h1>
        <p>This chart shows how many songs were collected from each country in "The Music of the Waters" -- an 1888 collection of sailors songs.</p>
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="{count($locations) * $yspacer + 150}">
            <g transform="translate(280, 100)">
                <g>
                    <text x="0" y="-5" font-family="sans-serif" font-size="20px" fill="black">Song Frequencies by Nation in The Music of the Waters</text>
                </g>
                <g>
                    {
